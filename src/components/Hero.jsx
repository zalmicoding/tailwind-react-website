  ...
  return (
    <div className='text-[#000000] `bg-[#4534] h-[34rem]'>
        <div className="max-w-800px mt-[-140px] w-full h-screen mx-auto text-center flex flex-col   justify-center">
            ...
            <h6 className='text-[#b2c08d] lg:text-4xl sm:text-6xl text:2xl font-bold md:py-6'>worldwebtree</h6>
            ...
            <p className='lg:text-2xl sm:4xl  lg:pl-4 text:lg  mt-4 font-bold pl-2 text-[#55dafceb]'>worldwebtree is a company where they provide sercices about software </p>
